"""Segment shapes out of a noisy synthetic scene with OpenCV and show the result in ft.Image."""
            ...
            content=ft.Column(
                ...
                controls=[
                    ...
                    view := ft.Image(
                        ...
                        border_radius=8,
                        # Without this the control blanks between frames, because every
                        # run hands it a different byte string rather than a new file.
                    ...
                    ft.Row(
                        controls=[
                            button := ft.Button(
                                "New scene", icon=ft.Icons.SHUFFLE, on_click=redraw
                            ),
